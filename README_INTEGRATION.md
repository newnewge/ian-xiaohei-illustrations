...
5 个广告语 / 文案 / 设计灵感数据源已接入，配套 **NEW-1｜广告语 → 配图**、**NEW-2｜情绪锚点 × 文案 × 配图**、**NEW-3｜排版合规校验** 三档新模板。  
服务"还没有文章"的头脑风暴阶段，与本页 4 个模板（已有文章）形成两条路径，汇合于 shot list。
...
| v1.1 | 2024-08 | 追加 `[[DATA_SOURCES_INTEGRATION]]` 入口：5 个数据源 + 3 档头脑风暴模板 |

## 数据源接入 → [[DATA_SOURCES_INTEGRATION]]
